...
class __TwigTemplate_b05a64f49abb5e0473508accf53153279643e91d8b2875a743ad359ebc456a4f extends Twig_Template
{
    ...
    ";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute(($context["lieu"] ?? null), "nom", array()), "html", null, true);
        echo "</h1>
    </br></br>
    <h4><span class=\"desctitle\">Categorie:</span> <span> ";
        // line 16
        echo twig_escape_filter($this->env, $this->getAttribute(($context["lieu"] ?? null), "categorie", array()), "html", null, true);
        echo "</h4>
    <h4><span class=\"desctitle\">Latitude :</span> <span> ";
        // line 17
        echo twig_escape_filter($this->env, $this->getAttribute(($context["lieu"] ?? null), "latitude", array()), "html", null, true);
        echo "</h4>
    <h4><span class=\"desctitle\">Longitude :</span> <span> ";
        // line 18
        echo twig_escape_filter($this->env, $this->getAttribute(($context["lieu"] ?? null), "longitude", array()), "html", null, true);
        echo "</h4>
    ";
        // line 19
        if ( !twig_test_empty($this->getAttribute(($context["desc"] ?? null), "adresse", array()))) {
            // line 20
            echo "        <h4><span class=\"desctitle\">Adresse :</span> <span>";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["desc"] ?? null), "adresse", array()), "html", null, true);
            echo "</span></h4>
    ";
        }
        // line 22
        echo "    ";
        if ( !twig_test_empty($this->getAttribute(($context["desc"] ?? null), "email", array()))) {
            // line 23
            echo "        <h4><span class=\"desctitle\">Email :</span> <span> ";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["desc"] ?? null), "email", array()), "html", null, true);
            echo "</span></h4>
    ";
        }
        // line 25
        echo "    ";
        if ( !twig_test_empty($this->getAttribute(($context["desc"] ?? null), "numTel", array()))) {
            // line 26
            echo "        <h4><span class=\"desctitle\">NumTél :</span> <span> ";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["desc"] ?? null), "numTel", array()), "html", null, true);
            echo "</span></h4>
    ";
        }
        // line 28
        echo "    ";
        if ( !twig_test_empty($this->getAttribute(($context["desc"] ?? null), "presentation", array()))) {
            // line 29
            echo "        <h4><span class=\"desctitle\">Présentation :</span> <span> ";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["desc"] ?? null), "presentation", array()), "html", null, true);
            echo "</span></h4>
    ";
        }
        // line 31
    ...
    <a class=\"btn btn-warning btn-block\" href=\"";
        // line 32
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("edit", array("id" => $this->getAttribute(($context["lieu"] ?? null), "id", array()))), "html", null, true);
        echo "\">
    ...
    <a class=\"btn btn-danger btn-block\" href=\"";
        // line 36
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("delete", array("id" => $this->getAttribute(($context["lieu"] ?? null), "id", array()))), "html", null, true);
        echo "\">
...
";
    ...
    {
        return new Twig_Source("", "pslieuxBundle:lieu:view.html.twig", "C:\\wamp64\\www\\Symfony\\var\\cache\\prod/../../../src/ps/lieuxBundle/Resources/views/lieu/view.html.twig");
    }
}
