...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            throw new \RuntimeException(sprintf('EntitysControlers "%s" does not exist in the "%s" bundle. Create it with the "doctrine:generate:entity" command and then execute this command again.', $entity, $bundle));
        }
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        $question = new Question($questionHelper->getQuestion('The EntitysControlers shortcut name', $input->getOption('entity')), $input->getOption('entity'));
        ...
        try {
            ...
            throw new \RuntimeException(sprintf('EntitysControlers "%s" does not exist in the "%s" bundle. You may have mistyped the bundle name or maybe the entity doesn\'t exist yet (create it first with the "doctrine:generate:entity" command).', $entity, $bundle));
        }
