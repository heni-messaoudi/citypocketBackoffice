...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $questionHelper->writeSection($output, 'EntitysControlers generation');
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        while (true) {
            ...
            try {
                ...
                if (!file_exists($b->getPath().'/EntitysControlers/'.str_replace('\\', '/', $entity).'.php')) {
                    break;
                }

                $output->writeln(sprintf('<bg=red>EntitysControlers "%s:%s" already exists</>.', $bundle, $entity));
            } catch (\Exception $e) {
